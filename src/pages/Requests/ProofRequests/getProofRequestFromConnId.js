function getTokenFromStorage() {
  ...
  export default async function getProofRequestFromConnId(connId) {
...
var requestOptions = {
  ...
  const response = await fetch(process.env.DB_URL + "/present-proof-2.0/records?connection_id="+connId, requestOptions);
